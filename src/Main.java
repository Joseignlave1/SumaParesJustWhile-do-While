...
public class Main {
    public static void main(String[] args) {
        ...
        while(isPrime == true && par <= n) {//Par <= n, ya qué par empieza en 2 ya qué es el menor par en números positivos, le sumamos 2 en cada iteracción,
